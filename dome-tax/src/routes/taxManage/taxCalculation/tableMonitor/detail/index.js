...
const Detail = ({
      taxCalculationStampDutyDetail,onBack,onSave
  }) => {
    console.log(taxCalculationStampDutyDetail)
    const {detailData}=taxCalculationStampDutyDetail
    const stampProps={
      title:"印花税计算表", 
      updateData:{}
    }
...
export default connect(({ taxCalculationStampDutyDetail, loading }) => ({ taxCalculationStampDutyDetail, loading }))(Detail)