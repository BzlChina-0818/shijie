...
const IncomeTable = ({
  ...
  const listProps = {
    ...
    onDetailItem(item) {
      dispatch(routerRedux.push({
        pathname:"/vat/calculate/incomeTable/detail",
        search: queryString.stringify({
          id:item.id
        }),
      }))
  ...
  const buttonGroupProps={
    onGoCreate() {
      dispatch(routerRedux.push({
        pathname:"/vat/calculate/incomeTable/create",
        search: queryString.stringify({
          ...query
        })
      }))
...
export default connect(({ VATCalculationSheet, loading }) => ({ VATCalculationSheet, loading }))(IncomeTable)
