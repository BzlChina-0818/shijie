...
const Filter = ({
  ...
  const { invoiceCode, invoiceNum, salesName } = filterData;
        ...
        <Panel header="蓝字发票查询" key="1">
          <Row gutter={24}>
            ...
            <Col {...ColProps}>
              <FormItem {...formItemLayout} label="发票号码">
                {getFieldDecorator("invoiceNum", { initialValue: invoiceNum })(
                  <Input />
                )}
              </FormItem>
            </Col>
          ...
          <Row gutter={24}>
            <Col offset={16} span={8} className="button-col">
              <Button className="margin-right" onClick={handleSubmit}>
                查询
              </Button>
