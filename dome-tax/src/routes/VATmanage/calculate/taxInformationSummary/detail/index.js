 ...
 * @backEnd  liyue
 */
const TaxInformationSummaryDetail = ({
  location, dispatch, taxInformationSummaryDetail, loading,
}) => {
  // const locationState = queryString.parse(location.search)
  // const { pathname } = location
  // const { list, pagination, modalVisible, selectedRows } = taxInformationSummaryDetail
  const goBack=()=>{
    history.go(-1)
  }
  const onExportRule=()=>{
...
TaxInformationSummaryDetail.propTypes = {
  taxInformationSummaryDetail: PropTypes.object,
  location: PropTypes.object,
  dispatch: PropTypes.func,
  loading: PropTypes.object,
}

export default connect(({ taxInformationSummaryDetail, loading }) => ({ taxInformationSummaryDetail, loading }))(TaxInformationSummaryDetail)
